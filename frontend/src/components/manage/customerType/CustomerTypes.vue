<template>
  <div>
    ...
    <el-button class="addBtn" type="primary"
      ...
      增加客户类型 <i class="el-icon-plus"></i>
    </el-button>
    <el-dialog title="客户类型编辑" :visible.sync="isEditting" @close="edittingModalClose">
      <CustomerTypeModal
...
<script>
//编辑对话框
import CustomerTypeModal from '@/components/manage/customerType/CustomerTypeModal'
//搜索模块
