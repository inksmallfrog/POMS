  ...
  <div :class="className">
   ...
   --><el-button :class="{searchTypeBtn : true, professionMode : professionSearch}"
      ...
      <el-form v-if="professionSearch" :model="formData" label-width="100px" class="professionForm">
        ...
        <el-form-item label="薪金范围" prop="salaryStart">
        <el-col :span="11">
        ...
        <el-form-item label="绩效工资范围" prop="salaryStart">
        <el-col :span="11">
          <el-input v-model="formData.scoreRatioStart" type="number" min="0.0" :max="formData.scoreRatioEnd" step="0.01"></el-input>
        </el-col>
        <el-col class="line" :span="2">-</el-col>
        <el-col :span="11">
          <el-input v-model="formData.scoreRatioEnd" type="number" :min="formData.scoreRatioStart" step="0.01"></el-input>
        </el-col>
        </el-form-item>
        <el-form-item label=" ">
