<template>
  <div>
    ...
    <el-button class="addBtn" type="primary"
      ...
      增加部门 <i class="el-icon-plus"></i>
    </el-button>
    <el-dialog title="部门编辑" :visible.sync="isEditting" @close="edittingModalClose">
      <DepartmentModal :edittingData="edittingData"
...
<script>
//编辑对话框
import DepartmentModal from '@/components/manage/department/DepartmentModal'
//搜索模块
