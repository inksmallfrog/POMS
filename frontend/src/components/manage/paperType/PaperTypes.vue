<template>
  <div>
    ...
    <el-button class="addBtn" type="primary"
      ...
      增加报刊类型 <i class="el-icon-plus"></i>
    </el-button>
    <el-dialog title="报刊类型编辑" :visible.sync="isEditting" @close="edittingModalClose">
      <PaperTypeModal :edittingData="edittingData"
...
<script>
//编辑对话框
import PaperTypeModal from '@/components/manage/paperType/PaperTypeModal'
//搜索模块
